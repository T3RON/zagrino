...
class Jszlist extends CI_Controller {
    ...
    function index()
    {
        ...
        //total rows count
        $totalRec = count($this->MY_Model->jobs_sub_cate_getRows($id));
        
        //pagination configuration
        $config['target']      = '#postList';
        $config['base_url']    = base_url().'site/work/Jlist/jobs_sub_cate_ajax/';
        $config['total_rows']  = $totalRec;
        $config['per_page']    = $this->perPage;
        $this->ajax_pagination->initialize($config);
        
        //get the posts data
        $output['jobs'] = $this->MY_Model->jobs_sub_cate_getRows($id,array('limit'=>$this->perPage));
    ...
    function jobs_sub_cate_ajax(){
        ...
        //get the posts data
        $output['agahi_car'] = $this->MY_Model->jobs_sub_cate_getRows($id,array('start'=>$offset,'limit'=>$this->perPage));
