...
class GardeshgariShow extends CI_Controller {
    ...
    function index()
    {
        ...
        $output['gardeshgari'] = $this->MY_Model->show_join_four('gardeshgari','accounts','ostan','city','state','gardeshgari',$id);
        ...
        $this->load->view('site/Gardeshgari_show', $output);
    }
