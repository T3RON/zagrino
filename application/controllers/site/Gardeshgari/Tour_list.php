...
class Tour_list extends CI_Controller {
    ...
    function index()
    {
        ...
        //total rows count
        $totalRec = count($this->MY_Model->tour_getRows());
        
        //pagination configuration
        $config['target']      = '#postList';
        $config['base_url']    = base_url().'site/Gardeshgari/Tour_list/tour_list_ajax/';
        $config['total_rows']  = $totalRec;
        $config['per_page']    = $this->perPage;
        $this->ajax_pagination->initialize($config);
        
        //get the posts data
        $output['tour'] = $this->MY_Model->tour_getRows(array('limit'=>$this->perPage));
        ...
        $this->load->view('site/Tour_list', $output);
    }
    ...
    function tour_list_ajax(){
        ...
        //get the posts data
        $output['tour'] = $this->MY_Model->tour_getRows(array('start'=>$offset,'limit'=>$this->perPage));
        ...
        $output['timeStamp'] = $this->jdf->jdate('l, j F Y',time(),'','GMT');
        //load the view
        $this->load->view('site/Ajax_tour_load', $output, false);
    }
}