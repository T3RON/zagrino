...
class Offersf extends MY_Controller {
    ...
    function index()
    {
        ...
        // $crud->where('zgr_takhfif.expire','>'.time());
        $crud->where('zgr_takhfif.state_id',7);
        $crud->set_table('zgr_takhfif');
        $crud->set_subject('تخفیفات معلق');
