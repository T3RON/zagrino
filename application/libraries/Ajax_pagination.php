...
class Ajax_pagination{
	...
	function getAJAXlink($count, $text) {
		...
		return '<a href="javascript:void(0);"' . $this->anchor_class . ' onclick="'.$this->link_func.'('.$pageCount.')">'. $text .'</li></a>';
	}
