...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url('')?>assets/site/fonts/flag-icon-css/css/flag-icon.min.css">
                    ...
                    <div class="body_panel">
                        <ul class="panel_ul">
                            <li class="panel_li panel_li_home p0">
                                <a href="/index.html" href="/index.html" >صفحه اول<img src="<?=base_url('')?>assets/site/img/iconfinder_home_126572.svg"></a></li>
                            <li class="panel_li panel_li_profile p0">
                                <a href="/Page_Profile.html" type="button"  >پنل کاربری<img src="<?=base_url('')?>assets/site/img/user.svg"></a></li>
                            <li class="panel_li panel_li_good p0">
                                <a href="/Page_GoodToKnow.html" type="button"  ><img src="<?=base_url('')?>assets/site/img/iconfinder_services_2639916.svg">تعرفه خدمات </a></li>
                            <li class="panel_li panel_li_profile p0">
                                <a href="/Page_Profile.html" type="button"  >نمایشگاه ها<img src="<?=base_url('')?>assets/site/img/user.svg"></a></li>
                            <li class="panel_li panel_li_good p0">
                                <a href="/Page_GoodToKnow.html" type="button"  ><img src="<?=base_url('')?>assets/site/img/iconfinder_services_2639916.svg">مشاوره رایگان</a></li>
                            <li class="panel_li panel_li_singup p0">
                                <a href="/Page_SignUp.html" type="button"  ><img src="<?=base_url('')?>assets/site/img/iconfinder_info2_216652.svg">درباره زاگرس زوم</a></li>
                            <li class="panel_li panel_li_request p0">
                                <a href="/Page_Program_Request.html" type="button"  ><img src="<?=base_url('')?>assets/site/img/contact.svg">ارتباط با ما</a>
                            </li>
                            <li class="panel_li panel_li_request p0">
                                <a href="/Page_Food_Request.html" type="button"  ><img src="<?=base_url('')?>assets/site/img/add.svg">ثبت رایگان شغل و آگهی</a></li>
                            <li class="panel_li panel_li_sharess p0">
                                <a href="/Page_Food_Request.html" type="button"  ><img src="<?=base_url('')?>assets/site/img/iconfinder_add_user_male_2639755.svg">ثبت نام / عضویت</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 search p0">
        ...
        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 search_filled f_r p0">
            <form class=" p0">
                ...
                <input id="search_input" name="s" type="text" class="col-lg-11 col-md-11 col-sm-11 col-xs-10 " placeholder="جستجو در سایت">
