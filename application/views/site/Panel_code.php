...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 slider clear">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ghavanin_2 p0">
                   ...
                   <ul class="p0">
                     ...
                     <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                         <li class="col-lg-6 col-md-12 col-sm-12 col-xs-12  f_r p0">
                             <div class="col-lg-1 col-md-1 col-sm-2 col-xs-3 sabad_kharid_icon f_r p0">
                                 <img src="img/shoping.svg">
                             </div>
                             <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 fild sabad_kharid_text p_0 f_r p0">
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section_head niazmandi_ghavanin p0">
    ...
    <div class="ol-lg-12 col-md-12 col-sm-12 col-xs-12 all_2">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 head_title_2">
            <span>
                زمان باقی مانده
            </span>
        </div>
        
                                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 time_zone p0" >
                                         ...
                                         <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 time_zone_m p0" >
                                         05
                                     </div>
                                         <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 time_zone_m p0" >
                                         05
                                   ...
                                   <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  ">
                                     ...
                                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 time_zone_info p0" >
                                         تعداد کد استفاده شده : ۲۱ کد
                                     </div>
                                       
                                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p0">
                                         مهلت استفاده : ۱۳۹۸/۰۵/۰۵
                                       </div>
                                       
                                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p0">
                                         تاریخ امروز : ۱۳۹۸/۰۴/۰۴
                                       </div>
