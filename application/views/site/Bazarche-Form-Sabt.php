<?php include_once (APPPATH.'views/_layout/site/header.php'); ?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section_head niazmandiha_form p0">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 outer bg_00bcd4 p0">
            فرم ثبت فروشگاه در بازارچه
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 left_side flex_item f_l b_m_v p0">
                        ...
                        <div class="col-lg-10 col-md-9 col-sm-6 col-xs-12 info_top title_info_all f_l p0">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text_1_2 f_r title_info_big  p0">کالای اصل را از ما بخرید</div>
           ...
           <form action="" method="" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title  p0">
                       ...
                       <label for="sefaresh_nam_neshan" class="p0">شماره شناسنامه</label>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_l  fild">
                <div class="t_align fild_title  p0">
                    <span class="f_r p0"></span>
                    <label for="sefaresh_nam_neshan" class="p0">مدرک تحصیلی </label>
                    <span class="f_l p0"></span>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in f_r">
                    <input id="sefaresh_nam_neshan" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                <div class="t_align fild_title  p0">
                    <span class="f_r p0"></span>
                    <label for="sefaresh_nam_neshan" class="p0">رزومه شما</label>
                    <span class="f_l p0"></span>
                </div>
                <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12 fild_in f_r">
                    <input id="sefaresh_nam_neshan" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_l  fild">
                <div class="t_align fild_title  p0">
                    <span class="f_r p0"></span>
                    <label for="sefaresh_nam_neshan" class="p0">آدرس فروشگاه</label>
                    <span class="f_l p0"></span>
                </div>
                <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12 fild_in f_r">
                    <input id="sefaresh_nam_neshan" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title  p0">
                       <span class="f_r p0"></span>
                       <label for="sefaresh_nam_neshan" class="p0">نام فروشگاه </label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in f_r">
                       <input id="sefaresh_nam_neshan" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_l  fild">
                   <div class="t_align fild_title  p0">
                       <span class="f_r p0"></span>
                       <label for="sefaresh_nam_neshan" class="p0">توضیحات فروشگاه </label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in f_r">
                       <input id="sefaresh_nam_neshan" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  f_r fild">
                <div class="t_align fild_title p0">
                    <span class="f_r p0"></span>
                    <label for="sefaresh_makan" class="p0">محل فروش</label>
                    <span class="f_l p0"></span>
                </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_l fild">
                   <div class="t_align fild_title  p0">
                       <span class="f_r p0"></span>
                       <label for="sefaresh_nam_neshan" class="p0">موبایل معتبر </label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in f_r">
                       <input id="sefaresh_nam_neshan" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_l fild">
                   <div class="t_align fild_title  p0">
                       <span class="f_r p0"></span>
                       <label for="sefaresh_nam_neshan" class="p0">تلفن </label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in f_r">
                       <input id="sefaresh_nam_neshan" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_l fild">
                   <div class="t_align fild_title  p0">
                       <span class="f_r p0"></span>
                       <label for="sefaresh_nam_neshan" class="p0">شبکه های اجتماعی </label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in f_r">
                       <input id="sefaresh_nam_neshan" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title  p0">
                       <span class="f_r p0"></span>
                       <label for="sefaresh_nam_neshan" class="p0">وب سایت </label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in f_r">
                       <input id="sefaresh_nam_neshan" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_l left clear p0">

                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="upload_img" class="p0">معرفی کالا، محصول و خدمات</label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in p0">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 i_i">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_17" class="p0">عنوان کالا، محصول و خدمات</label>
                       <span class="f_l p0"></span>
                   </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_17" class="p0">انتخاب دسته بندی</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="fild_in_17" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 input p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_17" class="p0">توضیح کالا، محصول و خدمات</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="fild_in_17" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 input p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_17" class="p0">قیمت</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="fild_in_17" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 input p0">
               ...
               <div class=" f_r img_panel_2 p0">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild f_r form_submit_div">
