    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 m_15 f_l p0">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 m_15 f_l">
            <div class="panel panel-default">
                <div style="text-align:center;" class="panel-heading">اقامتگاه</div>
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <div class="btn-group btn-group-justified" role="group" aria-label="...">
                            <div class="btn-group" role="group">
                                <a href="<?= base_url('site/Gardeshgari/Eghamatgah/vip'); ?>">
                                    <button type="button" class="btn btn-danger">اقامتگاه ویژه</button>
                                </a>
                            </div>
                            <div class="btn-group" role="group">
                                <a href="<?= base_url('site/Gardeshgari/Eghamatgah/free'); ?>">
                                    <button type="button" class="btn btn-info"> اقامتگاه معمولی</button>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 m_15 f_l">
            <div class="panel panel-default">
                <div style="text-align:center;" class="panel-heading">گردشگری</div>
                <div class="panel-body">
                    <div class="col-xs-12 col-md-12">
                        <a href="" class="thumbnail">
                        ...
                        <div class="btn-group btn-group-justified" role="group" aria-label="...">
                            <div class="btn-group" role="group">
                                <a href="<?= base_url('site/Gardeshgari/Gardesh/vip'); ?>">
                                    <button type="button" class="btn btn-danger">گردشگری ویژه</button>
                                </a>
                            </div>
                            <div class="btn-group" role="group">
                                <a href="<?= base_url('site/Gardeshgari/Gardesh/free'); ?>">
                                    <button type="button" class="btn btn-info">گردشگری معمولی</button>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 m_15 f_l">
            <div class="panel panel-default">
                <div style="text-align:center;" class="panel-heading">تور ها</div>
                <div class="panel-body">
                    <div class="col-xs-12 col-md-12">
