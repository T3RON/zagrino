        ...
        <div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section_head Agahiha_Niazmandiha p0">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 right_side f_r p0">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 list">
                    ...
                    <?php foreach ($agahi_cate as $agahi_cate) {  ?>
                        <?php $CI =& get_instance();
                            if($CI->agahi_check_record($agahi_cate->agahi_cate_id)) { ?>
                        <li class="col-lg-12 col-md-12 col-sm-12 col-xs-6 p0"><a href="<?= base_url('site/Agahi/Alist'); ?>/sub_list/<?= $agahi_cate->agahi_cate_id; ?>">
                            <?= $agahi_cate->agahi_cate_title; ?>
                        </a></li>
                        <?php } ?>
                    <?php } ?>
