               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_l left p0">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                    ...
                    <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in img_place  ">
                     ...
                     <div class="img_panel_2 p0">
                         <img src="<?=base_url('')?>assets/site/img/logo.png" id="imgshow_90">
                         <div class="f_r img_panel_input_2">
                             <img src="<?=base_url('')?>assets/site/img/camera.svg">
                             <input id="upload_img_90" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 u_i c_btn workout_btn " type="file" multiple=""></div>
                     </div>
                        </li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="upload_img" class="p0">آپلود چهار عکس مربوط به مجوزها و اعتبار شما</label>
                        <span class="f_l p0"></span>
                    </div>
                    <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in img_place  ">
                        <li class="c">
                     ...
                     <div class="img_panel_2 p0">
                         <img src="<?=base_url('')?>assets/site/img/logo.png" id="imgshow_80">
                         <div class="f_r img_panel_input_2">
                             <img src="<?=base_url('')?>assets/site/img/camera.svg">
                             <input id="upload_img_80" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 u_i c_btn workout_btn " type="file" multiple=""></div>
                     </div>
                        </li>
                        <li class="">
                            
                     <div class="img_panel_2 p0">
                         <img src="<?=base_url('')?>assets/site/img/logo.png" id="imgshow_81">
                         <div class="f_r img_panel_input_2">
                             <img src="<?=base_url('')?>assets/site/img/camera.svg">
                             <input id="upload_img_81" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 u_i c_btn workout_btn " type="file" multiple=""></div>
                     </div>
                        </li>
                        <li class="">
                            
                     <div class="img_panel_2 p0">
                         <img src="<?=base_url('')?>assets/site/img/logo.png" id="imgshow_82">
                         <div class="f_r img_panel_input_2">
                             <img src="<?=base_url('')?>assets/site/img/camera.svg">
                             <input id="upload_img_82" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 u_i c_btn workout_btn " type="file" multiple=""></div>
                     </div>
                        </li>
                        <li class="">
                            
                     <div class="img_panel_2 p0">
                         <img src="<?=base_url('')?>assets/site/img/logo.png" id="imgshow_83">
                         <div class="f_r img_panel_input_2">
                             <img src="<?=base_url('')?>assets/site/img/camera.svg">
                             <input id="upload_img_83" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 u_i c_btn workout_btn " type="file" multiple=""></div>
                     </div>
                        </li>
                    </ul>
                </div>
