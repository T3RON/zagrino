           ...
           <form action="" method="" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in img_place ">
                       <li class="col-lg-6 col-md-6 col-sm-4 col-xs-6">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 f_r img_panel_2 p0">
                            <img src="img/logo.png" id="imgshow_4">
                       ...
                       <li class="col-lg-6 col-md-6 col-sm-4 col-xs-6">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 f_r img_panel_2 p0">
                            <img src="img/logo.png" id="imgshow_40">
                            <div class="f_r img_panel_input_2">
                                <img src="img/camera.svg">
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_r clear fild">
                ...
                <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in img_place ">
                 ...
                 <div class="f_r img_panel_2 p0">
                     <img src="img/logo.png" id="imgshow_411">
                     <div class="f_r img_panel_input_2">
                         <img src="img/camera.svg">
                 ...
                 <div class="f_r img_panel_2 p0">
                     <img src="img/logo.png" id="imgshow_422">
                     <div class="f_r img_panel_input_2">
                         <img src="img/camera.svg">
                 ...
                 <div class="f_r img_panel_2 p0">
                     <img src="img/logo.png" id="imgshow_433">
                     <div class="f_r img_panel_input_2">
                         <img src="img/camera.svg">
                 ...
                 <div class="f_r img_panel_2 p0">
                     <img src="img/logo.png" id="imgshow_444">
                     <div class="f_r img_panel_input_2">
                         <img src="img/camera.svg">
                 ...
                 <div class="f_r img_panel_2 p0">
                     <img src="img/logo.png" id="imgshow_455">
                     <div class="f_r img_panel_input_2">
                         <img src="img/camera.svg">
                 ...
                 <div class="f_r img_panel_2 p0">
                     <img src="img/logo.png" id="imgshow_466">
                     <div class="f_r img_panel_input_2">
                         <img src="img/camera.svg">
               ...
               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 f_r text_title">
                   آپلود پوستر
                   
               </div>
               <div class="col-lg-6 col-md-6 col-sm-6 hidden-xs text_title">
                آپلود کلیپ رویداد
               ...
               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 f_r  fild">
                   <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in img_place ">
                       <li class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 f_r img_panel_2 p0">
                            <img src="img/logo.png" id="imgshow_477">
                            <div class="f_r img_panel_input_2">
                                <img src="img/camera.svg">
               ...
               <div class="hidden-lg hidden-md hidden-sm col-xs-12 text_title">
                آپلود کلیپ رویداد
               ...
               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 f_r  fild">
                   <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in img_place ">
                       <li class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 f_r img_panel_2 p0">
                            <img src="img/logo.png" id="imgshow_47">
                            <div class="f_r img_panel_input_2">
                                <img src="img/camera.svg">
