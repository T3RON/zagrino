    ...
    <div class="container-fluid bg_con shad_box">
       ...
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 all ">
           ...
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ghavanin_2 p0">
            کد های خریداری شده من
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ghavanin_2 p0">
            
                     <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                         <li class="col-lg-6 col-md-12 col-sm-12 col-xs-12 sabad_kharid_li f_r p0">
                             <div class="col-lg-1 col-md-2 col-sm-2 col-xs-32 sabad_kharid_icon f_r p0">
                                 <img src="img/shoping.svg">
                             </div>
                             <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 fild sabad_kharid_text f_r p0">
                                 091811111111
                             </div>
                         </li>
                     </ul>
