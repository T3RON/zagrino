...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section_head niazmandiha_form p0 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 all">
        ...
        <?php if($vip) { ?>
        <form action="<?= base_url('site/Gardeshgari/Gardesh/vip_register'); ?>" method="post"
            enctype='multipart/form-data' class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
            <?php } else { ?>
            <form action="<?= base_url('site/Gardeshgari/Gardesh/free_register'); ?>" method="post"
                enctype='multipart/form-data' class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                <?php } ?>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r fild">
                    <div class="t_align fild_title p0">
                        ...
                        <label for="naghlie_mozo" class="p0">عنوان گردشگری </label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                        <input name="gardeshgari_title" id="naghlie_mozo" type="text"
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="naghlie_tozihat_kamel" class="p0"> قدمت شهر</label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                        <input name="gardeshgari_ghedmat" id="naghlie_tozihat_kamel" rows="4"
                            class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_r fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="naghlie_gheimat" class="p0">توضیحات گردشگری</label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">

                            <textarea name="gardeshgari_des" id="naghlie_gheimat" type="text"
                            class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0" rows="4" cols="50"></textarea>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="naghlie_tozihat_kamel" class="p0">شرایط </label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                        <input name="gardeshgari_conditons" id="naghlie_tozihat_kamel" rows="4"
                            class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="naghlie_mobile_motabar" class="p0"> بهترین زمان سفر </label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                        <input name="gardeshgari_best_time" id="naghlie_mobile_motabar" type="text"
                            class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="naghlie_mobile_motabar" class="p0"> آدرس</label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                        <input name="gardeshgari_address" id="naghlie_mobile_motabar" type="text"
                            class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                    </div>
                </div>
                ...
                <div class="flex_boxl">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 tavajoh ">
                        ...
                        <p>
                            ...
                            جهت استفاده از امکانات و تعداد روز های بیشتر  گردشگری 12 ویژه را انتخاب نمایید
                            <?php } ?>
