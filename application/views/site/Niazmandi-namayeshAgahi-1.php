<?php include_once (APPPATH.'views/_layout/site/header.php');?>
    ...
    <div class="col-lg-12 niazmandi_n_a b_m_v p0">
    ...
    <div class="col-lg-12 border_box">
        ...
        <div class="info_mid info_top">
            ...
            <div class="col-lg-12 title">فروش یک دستگاه خودرو سانتافه</div>
            <div class="col-lg-12 update">آخرین به روز رسانی :
                <span>18/05/1398</span>
            </div>
            <div class="col-lg-12 agahi_dahande">آگهی دهنده :
                <span>احمد یوسف وند</span>
            </div>
            ...
            <div class="col-lg-12 shomare_tamas">شماره تماس :
                <span>09******989</span>
                <a class="namayesh_phone" href="">نمایش</a>
            </div>
            </div>
            </div>
        ...
        <div class="info_mid info_top">
            ...
            <div class="observe f_r p0">
                <i class="icon-eye f_r"></i>۰۵/۰۵/۱۳۹۷ تا ۰۵/۰۸/۱۳۹۸</div>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p_btn_package right_col f_r flex_box p0">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 left_side m_p_10 p0">
                ...
                <button class="col-lg-12 col-md-12 col-sm-12 col-xs-12 main_button_agahi" >مشاهده همه آگهی های این کاربر</button>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p_btn_package border_hoshtar f_r p0">
            ...
            <div class="red ">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد</div>
            <div class="green ">لورم ایپسوم متن </div>
            <div class="green ">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</div>
            <div class="green ">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت </div>
            <div class="green ">دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد</div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p_btn_package  f_l p0">
            ...
            <form class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_r p0">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_r niazmandi_send_pm">ارسال پیام به آگهی دهندی :</div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 c_bg p0">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 upper p0">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 c_text f_l p0">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 c_title f_r p0">فروش یک دستگاه وسیله نقلیه</div>
                                </div>
                            </div>
