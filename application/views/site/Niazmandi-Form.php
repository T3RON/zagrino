...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 all">
   ...
   <form action="" method="" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title  p0">
                       <span class="f_r p0"></span>
                       <label for="sefaresh_nam_neshan" class="p0">نام و نشانی آگهی دهنده / شرکت</label>
                       <span class="f_l p0"></span>
                   </div>
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text_title">
                   انتخاب تعرفه و مدت زمان انتشار را تعیین کنید
               </div>

               <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 f_r fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="sefaresh_tarefeh" class="p0">انتخاب تعرفه</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in select">
                       <select id="sefaresh_tarefeh" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
               ...
               <div class="col-lg-3 col-md-4 col-sm-4 col-xs-9 f_r fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="sefaresh_zaman_namayesh" class="p0">مدت زمان نمایش</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in select">
                       <select id="sefaresh_zaman_namayesh" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                           <option value="none" selected disabled hidden > </option>
               ...
               <div class="tarefeh_link m_18 f_r"><a href="">
                       مشاهده تعرفه ها
               </a></div>
               ...
               <div class="col-lg-6 col-md-10 col-sm-9 col-xs-7 f_r fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_10" class="p0">انتخاب گروه</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in select">
                       <select id="fild_in_10" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                           <option value="none" selected disabled hidden > </option>
                           <option value="1">عادی</option>
                           <option value="2">شگفتانه</option>
                           <option value="3">همگانی</option>
               ...
               <button class="col-lg-2 col-md-2 col-sm-3 col-xs-5 button_change" type="" href="" >
                   تغییر دسته بندی
                   <i class="icon-plus"></i>
               </button>
               ...
               <div class="col-lg-6 col-md-10 col-sm-9 col-xs-7 f_r  fild">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-9 col-xs-12 fild_in select">
               ...
               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 f_r clear fild">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="tozihat_text" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text_title">
                   آگهی رایگان دو تصویر بدون لینک
               </div>
               ...
               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 text_title">
                   موقعیت آگهی
               </div>

               <button class="col-lg-6 col-md-12 col-sm-12 col-xs-12 main_button" type="" href="" >
               ...
               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 f_r fild p0 p0">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="adres" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>

               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild f_l select_map">
                   <!--Google map-->
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 map" id="map" style="position: relative; overflow: hidden;"><div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);"><div class="gm-err-container"><div class="gm-err-content"><div class="gm-err-icon"><img src="https://maps.gstatic.com/mapfiles/api-3/images/icon_error.png" draggable="false" style="user-select: none;"></div><div class="gm-err-title">Oops! Something went wrong.</div><div class="gm-err-message">This page didn't load Google Maps correctly. See the JavaScript console for technical details.</div></div></div></div></div>
               </div>
               ...
               <div class="ccol-lg-12 col-md-12 col-sm-12 col-xs-12 form_midle_title">
                   <div class="form_midle_title_in">
                   <span>
                   فرم ثبت آگهی کالا
                   </span>
               ...
               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 f_r fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_28" class="p0">موضوع آگهی</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_28" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-10 col-sm-9 col-xs-7 f_r clear fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_29" class="p0">انتخاب گروه</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in select">
                       <select id="fild_in_29" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                           <option value="none" selected disabled hidden > </option>
                           <option value="1">عادی</option>
                           <option value="2">شگفتانه</option>
                           <option value="3">همگانی</option>
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_r fild">
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                       <div class="t_align fild_title margin_title p0">
                           <span class="f_r p0"></span>
                           <label for="tozihat_text" class="p0">درخواست آگهی (برچسب)</label>
                           <span class="f_l p0"></span>
                       </div>
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_r fild">
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                       <div class="t_align fild_title margin_title p0">
                           <span class="f_r p0"></span>
                           <label for="tozihat_text" class="p0">تعیین اولویت و نوع شرایط ( برچسب )</label>
                           <span class="f_l p0"></span>
                       </div>
                       <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in niazmandi_radio ">
                           <li class="col-lg-2 col-md-3 col-sm-6 col-xs-12 p0">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_30" class="p0">درج قیمت به تومان</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_30" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="tozihat_kamel_koli" class="p0">توضیحات کامل</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="tozihat_kamel_koli" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_31" class="p0">کدملی ( اختیاری )</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_31" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_32" class="p0">موبایل معتبر</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_33" class="p0">تلفن</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_33" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_34" class="p0">آدرس ایمیل</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_34" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12   fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_35" class="p0">لینک آگهی</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_35" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 f_r clear text_title">
                موقعیت آگهی
            </div>
...
<!------------------------------ فرم ثبت آگهی کلی ----------------------->
               ...
               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 f_r fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_19" class="p0">موضوع آگهی</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_19" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-10 col-sm-9 col-xs-7 f_r clear fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_20" class="p0">انتخاب گروه</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in select">
                       <select id="fild_in_20" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                           <option value="none" selected disabled hidden > </option>
                           <option value="1">عادی</option>
                           <option value="2">شگفتانه</option>
                           <option value="3">همگانی</option>
               ...
               <button class="col-lg-2 col-md-2 col-sm-3 col-xs-5 button_change" href="" >
                   تغییر دسته بندی
                   <i class="icon-plus"></i>
               </button>
               ...
               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 f_r fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_21" class="p0">درج قیمت به تومان</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_21" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="tozihat_kamell" class="p0">توضیحات کامل</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="tozihat_kamell" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_22" class="p0">کدملی ( اختیاری )</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_22" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_23" class="p0">موبایل معتبر</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="fild_in_23" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_24" class="p0">تلفن</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_24" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_25" class="p0">آدرس ایمیل</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_25" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="fild_in_26" class="p0">لینک آگهی</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="fild_in_26" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_r clear fild f_l select_map">
                <!--Google map-->
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 map" id="map" style="position: relative; overflow: hidden;"><div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);"><div class="gm-err-container"><div class="gm-err-content"><div class="gm-err-icon"><img src="https://maps.gstatic.com/mapfiles/api-3/images/icon_error.png" draggable="false" style="user-select: none;"></div><div class="gm-err-title">Oops! Something went wrong.</div><div class="gm-err-message">This page didn't load Google Maps correctly. See the JavaScript console for technical details.</div></div></div></div></div>
            </div>
...
<!----------------------------------------------------------------------------------------  فرم ثبت آگهی وسایل نقلیه ----------------------------------------------------------->
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_r fild">
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                       <div class="t_align fild_title margin_title p0">
                           <span class="f_r p0"></span>
                           <label class="p0">تعیین اولویت و نوع شرایط ( برچسب )</label>
                           <span class="f_l p0"></span>
                       </div>
                       <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in niazmandi_radio">
                           <li class="col-lg-2 col-md-3 col-sm-6 col-xs-12 p0">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_l flex_box_in p0">
                       ...
                       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_l fild">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                               ...
                               <input id="naghlie_mashin_sangin" type="text" class="col-lg-11 col-md-11 col-sm-11 col-xs-11 p0">
                           </div>
                       </div>
                       ...
                       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_l fild">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                               <div class="col-lg-1 f_r t_align p0">نوع :</div>
                               <input id="naghlie_mashin_nime_sangin" type="text" class="col-lg-11 col-md-11 col-sm-11 col-xs-11 p0">
                           </div>
                       </div>
                       ...
                       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_l fild">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                               <div class="col-lg-1 f_r t_align p0">نوع :</div>
                               <input id="naghlie_mashin_alat" type="text" class="col-lg-11 col-md-11 col-sm-11 col-xs-11 p0">
                           </div>
                       </div>
                       ...
                       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r fild">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                               <div class="col-lg-1 f_r t_align p0">نوع :</div>
                               <input id="naghlie_docharkhe" type="text" class="col-lg-11 col-md-11 col-sm-11 col-xs-11 p0">
                           </div>
                       </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 m_10 f_r fild">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in body">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="khodro_vaziat" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="khodro_sookht" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="khodro_noe_pelak" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="khodro_range_badane" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="khodro_range_dakhel" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="khodro_vaziat_badane" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="khodro_vaziat_motor" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="khodro_etebar_bime" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="khodro_takhfif_bime" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="khodro_tozihattakmili" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 m_10 f_l fild">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in body ">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                                <input id="motor_karkard" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                                <input id="motor_jabe_dande" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="motor_tedad_dande" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                                <input id="khodro_noe_start" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                                <input id="motor_noe_ring" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                                <input id="motor_noe_pelak" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="motor_hajm_motor" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="motor_vaziat_badane" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="motor_tozihat_takmili" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 m_10 f_r fild">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in body">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="docharkhe_vaziat" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="docharkhe_size" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="docharkhe_dande" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="docharkhe_tormoz" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="docharkhe_tozihattakmili" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 m_10 f_l fild">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in body">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="sangin_vaziat" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                                <input id="sangin_sale_sakht" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  fild">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                                <input id="sangin_tozihattakmili" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                            </div>
                        </div>
                    </div>
                </div>
               ...
               <button class="col-lg-6 col-md-12 col-sm-12 col-xs-12 f_r main_button" type="" href="" >
                   تعیین موقعیت روی نقشه
               </button>
...
<!------------------- فرم ثبت آگهی فروش املاک ------------------------->
               ...
               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 f_r fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="foroosh_amlak_mozo" class="p0">موضوع آگهی</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="foroosh_amlak_mozo" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-10 col-sm-9 col-xs-7 f_r clear fild">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in select">
                       <select id="foroosh_amlak_gorooh" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                           <option value="none" selected disabled hidden > </option>
                           <option value="1">عادی</option>
                           <option value="2">شگفتانه</option>
                           <option value="3">همگانی</option>
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_r fild">
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild">
                       ...
                       <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in niazmandi_radio">
                           <li class="col-lg-2 col-md-3 col-sm-4 col-xs-12 p0">
                               <label class="col-lg-12 col-md-12 col-sm-12 col-xs-12 radio_label p0">
                                   <span>پزشکی </span>
                                   <input type="checkbox" name="">
                                   <span class="checkmark"></span>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r fild">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="foroosh_amlak_gheimat" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="foroosh_amlak_cod_meli" class="p0">کد ملی (اختیاری)</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="foroosh_amlak_cod_meli" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="foroosh_amlak_email" class="p0">آدرس ایمیل</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="foroosh_amlak_email" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="foroosh_amlak_link" class="p0">لینک آگهی</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="foroosh_amlak_link" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 fild vaziat_kala">
                   ...
                   <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 radio_input">
                       <label class="col-lg-12 col-md-12 col-sm-12 col-xs-12 radio_label p0">
                           <span>مالک </span>
                           <input type="radio" name="radio_1">
                           <span class="checkmark"></span>
                   ...
                   <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r fild">
                       <div class="t_align fild_title p0">
                           <span class="f_r p0"></span>
                           <label for="name_bongah" class="p0">نام بنگاه</label>
                           <span class="f_l p0"></span>
                       </div>
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                           <input id="name_bongah" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                       </div>
                   </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="metrazh" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="vaziat_sanad" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                    <input id="mizan_malekiat" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                </div>
            </div>
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title margin_title p0">
                       <span class="f_r p0"></span>
                       <label class="p0">نوع سند</label>
                       <span class="f_l p0"></span>
                   </div>
                   <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in niazmandi_radio">
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r clear fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="foroosh_amlak_tozihat" class="p0">توضیحات کامل</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                       <input id="foroosh_amlak_tozihat" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
...
<!--------------------------------- فرم ثبت آگهی اجاره املاک ---------------------------------->
               ...
               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 f_r fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_mozo" class="p0">موضوع آگهی</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_mozo" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-10 col-sm-9 col-xs-7 f_r clear fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_gorooh" class="p0">انتخاب گروه</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in select">
                       <select id="ejareh_melk_gorooh" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                           <option value="none" selected disabled hidden > </option>
                           <option value="1">عادی</option>
                           <option value="2">شگفتانه</option>
                           <option value="3">همگانی</option>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_gheimat" class="p0">درج قیمت به تومان</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_gheimat" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_tozihat_kamel" class="p0">توضیحات کامل</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_tozihat_kamel" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_cod_meli" class="p0">کد ملی (اختیاری)</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 fild_in ">
                       <input id="ejareh_melk_cod_meli" type="text" class="col-lg-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_mobile" class="p0">موبایل معتبر</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_mobile" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_telephone" class="p0">تلفن</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_telephone" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_email" class="p0">آدرس ایمیل</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_email" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_link_agahi" class="p0">لینک آگهی</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_link_agahi" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_mablagh_rahn" class="p0">مبلغ رهن</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_mablagh_rahn" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_mablagh_ejareh" class="p0">مبلغ اجاره</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_mablagh_ejareh" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_metrazh" class="p0">متراژ</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_metrazh" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_sale_sakht" class="p0">سال ساخت</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_sale_sakht" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_malek" class="p0">مالک</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_malek" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_tedad_tabaghe" class="p0">تعداد طبقات</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_tedad_tabaghe" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_tedad_vahed" class="p0">تعداد واحد در طبقه</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_tedad_vahed" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_parking" class="p0">پارکینگ</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_parking" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_tedad_khat_telephone" class="p0">تعداد خطوط تلفن</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_tedad_khat_telephone" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_tedad_otagh" class="p0">تعداد اتاق</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_tedad_otagh" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_asansor" class="p0">آسانسور</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_asansor" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_anbari" class="p0">انباری</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_anbari" type="text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                   <div class="t_align fild_title p0">
                       <span class="f_r p0"></span>
                       <label for="ejareh_melk_tozihat" class="p0">توضیحات کامل</label>
                       <span class="f_l p0"></span>
                   </div>
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in ">
                       <input id="ejareh_melk_tozihat" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                   </div>
               </div>
