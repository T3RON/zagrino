...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section_head niazmandiha_form p0 ">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 all">
        ...
        <?php if($vip) { ?>
        <form action="<?= base_url('site/Gardeshgari/Eghamatgah/vip_register'); ?>" method="post"
            enctype='multipart/form-data' class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
            <?php } else { ?>
            <form action="<?= base_url('site/Gardeshgari/Eghamatgah/free_register'); ?>" method="post"
                enctype='multipart/form-data' class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                <?php } ?>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r fild">
                    <div class="t_align fild_title p0">
                        ...
                        <label for="naghlie_mozo" class="p0">عنوان اقامتگاه </label>
                ...
                <div class="col-lg-6 col-md-10 col-sm-9 col-xs-7 f_r fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="foroosh_amlak_gorooh" class="p0"> نوع اقامتگاه</label>
                        <span class="f_l p0"></span>
                    </div>
                ...
                <div class="col-lg-6 col-md-16 col-sm-12 col-xs-12 f_r fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="naghlie_gheimat" class="p0">طبقه</label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="naghlie_tozihat_kamel" class="p0"> تعداد اتاق</label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r  fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="naghlie_tozihat_kamel" class="p0">شرایط اقامت</label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="naghlie_mobile_motabar" class="p0"> تاریخ تحویل</label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 f_r fild">
                    <div class="t_align fild_title p0">
                        <span class="f_r p0"></span>
                        <label for="naghlie_mobile_motabar" class="p0"> تاریخ تخلیه</label>
                        <span class="f_l p0"></span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fild_in">
