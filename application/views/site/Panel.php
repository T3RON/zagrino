                       ...
                       <div   class="col-lg-12 col-md-12 col-sm-12 col-xs-12  p0">
                           <ul class=" m_5 p0">
                               <li class="col-lg-12 col-md-12 col-sm-12 hidden-xs today-li-tittle p_10_5 p0">
                                   <ul class="p0">
                                       <li class="col-lg-4 col-md-5 col-sm-4 col-xs-7 today-li-inner-tittle f_r p0">نام کالا یا محصول</li>
                                       <li class="col-lg-3 col-md-3 col-sm-3 col-xs-2 today-li-inner black f_r p0">مبلغ کالا بدون تخفیف به تومان</li>
                                       <li class="col-lg-2 hidden-md hidden-sm hidden-xs today-li-inner red f_r p0">درصد تخفیف</li>
                                       <li class="col-lg-2  col-md-3 col-sm-3 col-xs-3 today-li-inner green f_r p0">قیمت با تخفیف</li>
                                       <li class="col-lg-1 col-md-1 col-sm-2 hidden-xs today-li-inner black f_r p0">تعداد کل</li>
                                   </ul>
                           </li>
                               <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 today-li m_2 p0">
                                <ul class="ul_buy p0">
                                       <li style="padding-top: 1px!important;" class="col-lg-4 col-md-5 col-sm-4 col-xs-6 today-li-inner-tittle f_r p0">کفش زنانه</li>
                                       <li class="col-lg-3 col-md-3 col-sm-3 col-xs-3 today-li-inner black f_r p0">۲۰۰/۰۰۰</li>
                                       <li class="col-lg-2 hidden-md hidden-sm hidden-xs today-li-inner red f_r p0">۲۰٪</li>
                                       <li class="col-lg-2 col-md-3 col-sm-3 col-xs-3 today-li-inner green f_r p0">۱۶۰/۰۰۰ </li>
