...
<div class="col-lg-12 niazmandi_n_a b_m_v p0 r">
    ...
    <div class="col-lg-12 border_box p0">
                ...
                <div class="info_mid info_top p0">
                    ...
                    <div class="col-lg-12 shomare_tamas">شماره تماس :
                        <span style="display: inline;"
                            id="hashed"><?= substr($agahi_value->account_mobile,8)  ?>******<?= substr($agahi_value->account_mobile,0,4)  ?></span>
                ...
                <div class="info_mid info_top p0">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 point_section f-r p0">
                        ...
                        <div class="observe f_r p0">
                            <i
                                class="icon-eye f_r"></i><?= $this->jdf->jdate('l, j F Y', $agahi_value->register_date, '', 'GMT'); ?>
                            تا <?= $this->jdf->jdate('l, j F Y', $agahi_value->expire, '', 'GMT'); ?>
                        </div>
                    </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p_btn_package right_col f_r flex_box p0">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 right_side flex_item f_r p0">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img_swiper bankmashaghel_img  p0">
                    <img src="<?=base_url('')?>assets/uploads/img/<?= $agahi_value->img1; ?>" class="" alt="" title="">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0 swiper-container swiper_bankMashaghel">
                    ...
                    <?php if($agahi_value->img1 != "<p></p>") { ?>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0 swiper-slide">
                            <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                    <a class="image-link"
                                        href="<?=base_url('')?>assets/uploads/img/<?= $agahi_value->img1; ?>">
                        ...
                        <?php } ?>
                        <?php if($agahi_value->img2 != "<p></p>") { ?>
                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 p0 swiper-slide">
                            <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                    <a class="image-link"
                                        href="<?=base_url('')?>assets/uploads/img/<?= $agahi_value->img2; ?>">
                        ...
                        <?php } ?>
                        <?php if($agahi_value->img3 != "<p></p>") { ?>
                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 p0 swiper-slide">
                            <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                    <a class="image-link"
                                        href="<?=base_url('')?>assets/uploads/img/<?= $agahi_value->img3; ?>">
                        ...
                        <?php } ?>
                        <?php if($agahi_value->img4 != "<p></p>") { ?>
                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 p0 swiper-slide">
                            <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                    <a class="image-link"
                                        href="<?=base_url('')?>assets/uploads/img/<?= $agahi_value->img4; ?>">
                        ...
                        <?php } ?>
                        <?php if($agahi_value->img5 != "<p></p>") { ?>
                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 p0 swiper-slide">
                            <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                    <a class="image-link"
                                        href="<?=base_url('')?>assets/uploads/img/<?= $agahi_value->img5; ?>">
                        ...
                        <?php } ?>
                        <?php if($agahi_value->img6 != "<p></p>") { ?>
                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 p0 swiper-slide">
                            <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                    <a class="image-link"
                                        href="<?=base_url('')?>assets/uploads/img/<?= $agahi_value->img6; ?>">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 left_side m_p_10 p0">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 info_top p0">
                    <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                        ...
                        <a href="<?= base_url('site/Agahi/Car/Show'); ?>/<?= $another_agahi_val->agahi_id; ?>/<?= $another_agahi_val->accounts_id; ?>">
                        <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 niazmadi_sayer_agahi p0">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3  f_r niazmadi_sayer_agahi_img p0">
                                <img src="<?=base_url('')?>assets/uploads/img/<?= $another_agahi_val->img1; ?>"
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 point_section ">
                                ...
                                <div class="hidden-xs observe f_r">
                                    <i class="icon-eye f_r"></i>
                                    <span>
                                        <?= $this->jdf->jdate('l, j F Y', $another_agahi_val->register_date, '', 'GMT'); ?>
                                        تا
                                        <?= $this->jdf->jdate('l, j F Y', $another_agahi_val->expire, '', 'GMT'); ?>
                                    </span>
                                </div>
                ...
                <a class="col-lg-12 col-md-12 col-sm-12 col-xs-12 main_button_agahi" href="<?= base_url('site/Agahi/Alist/user_list'); ?>/<?= $agahi_value->accounts_id; ?>">مشاهده همه آگهی های این کاربر</a>
        ...
        var map = L.map("map").fitBounds([
            [<?= $agahi_value->agahi_latitude; ?>, <?= $agahi_value->agahi_longitude; ?>]
        ]);
        L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', {
            attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors',
            maxZoom: 18
        }).addTo(map);
        var marker = L.marker([<?= $agahi_value->agahi_latitude; ?>, <?= $agahi_value->agahi_longitude; ?>]).addTo(map);
        var currentMarker;
        ...
        <div class="frm col-lg-6 col-md-6 col-sm-12 col-xs-12 p_btn_package f_l p0">
            ...
            <input id="id" type="hidden" value="<?= $agahi_value->agahi_id; ?>">
            <input id="accounts_id" type="hidden" value="<?= $agahi_value->accounts_id; ?>">
