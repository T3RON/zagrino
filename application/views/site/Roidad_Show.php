...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 niazmandi_n_a  b_m_v p0">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  border_box">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 info_mid info_top p0">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 tag_niazmandi">
                            <?= $events_value->events_cate_title; ?></div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 big_font ">
                            <?= $events_value->events_title; ?></div>
                        <div class="ccol-lg-12 col-md-12 col-sm-12 col-xs-12  cod_agahi">کد آگهی :
                            <span><?= $events_value->events_id; ?></span>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 "><?= $events_value->events_address; ?> :
                            آدرس </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 roidadha_info p0">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 roidadha_info_inner">
                        <a href="#">
                            ...
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-10 info_inner_title ">
                                استان : <?= $events_value->ostan_title; ?> , شهرستان : <?= $events_value->city_title; ?>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 roidadha_info_inner">
                        <a href="#">
                            ...
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-10 info_inner_title ">
                                <?= $events_value->events_type; ?> : نوع رویداد
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 roidadha_info_inner">
                        <a href="#">
                            ...
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-10 info_inner_title ">
                                <?= $events_value->events_finish; ?> تا <?= $events_value->events_start; ?> : زمان
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 roidadha_info_inner">
                        <a href="#">
                            ...
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-10 info_inner_title ">
                                <?= $events_value->events_level; ?> : سطح برگزاری
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 roidadha_info_inner">
                        <a href="#">
                            ...
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-10 info_inner_title ">
                                <?= $events_value->events_run; ?> : برگزار کنندگان
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 roidadha_info p0">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 roidadha_info_inner">
                        <a href="#">
                            ...
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-10 info_inner_title ">
                                <?= $events_value->events_capacity; ?> : ظرفیت
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 roidadha_info_inner">
                        <a href="#">
                            ...
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-10 info_inner_title ">
                                <?= $events_value->events_link_site; ?> : آدرس سایت
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 roidadha_info_inner">
                        <a href="#">
                            ...
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-10 info_inner_title ">
                                <?= $events_value->events_email; ?> : آدرس ایمیل
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 right_side flex_item f_r p0">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 right_side flex_item f_r p0">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img_swiper bankmashaghel_img  p0">
                        <img src="<?=base_url('')?>assets/uploads/img/<?= $events_value->img1; ?>" class="" alt=""
                            title="">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0 swiper-container swiper_bankMashaghel">
                        <div class="swiper-wrapper">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0 swiper-slide">
                                <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                        <a class="image-link"
                                            href="<?=base_url('')?>assets/uploads/img/<?= $events_value->img1; ?>">
                            ...
                            <?php } ?>
                            <?php if($events_value->img2 != "<p></p>") { ?>
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 p0 swiper-slide">
                                <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">

                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                        <a class="image-link"
                                            href="<?=base_url('')?>assets/uploads/img/<?= $events_value->img2; ?>">
                                            <img src="<?=base_url('')?>assets/uploads/img/<?= $events_value->img2; ?>"
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 p0 swiper-slide">
                                <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                        <a class="image-link"
                                            href="<?=base_url('')?>assets/uploads/img/<?= $events_value->img3; ?>">
                                            <img src="<?=base_url('')?>assets/uploads/img/<?= $events_value->img3; ?>"
                                                class="img-responsive" alt="" title="">
                                        </a>
                                    </div>
                            ...
                            <?php } ?>
                            <?php if($events_value->img4 != "<p></p>") { ?>
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 p0 swiper-slide">
                                <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">

                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                        <a class="image-link"
                                            href="<?=base_url('')?>assets/uploads/img/<?= $events_value->img4; ?>">
                                            <img src="<?=base_url('')?>assets/uploads/img/<?= $events_value->img4; ?>"
                                                class="img-responsive" alt="" title="">
                                        </a>
                                    </div>
                            ...
                            <?php } ?>
                            <?php if($events_value->img5 != "<p></p>") { ?>
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 p0 swiper-slide">
                                <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">

                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                        <a class="image-link"
                                            href="<?=base_url('')?>assets/uploads/img/<?= $events_value->img5; ?>">
                                            <img src="<?=base_url('')?>assets/uploads/img/<?= $events_value->img5; ?>"
                                                class="img-responsive" alt="" title="">
                                        </a>
                                    </div>
                            ...
                            <?php } ?>
                            <?php if($events_value->img6 != "<p></p>") { ?>
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 p0 swiper-slide">
                                <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">

                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img p0">
                                        <a class="image-link"
                                            href="<?=base_url('')?>assets/uploads/img/<?= $events_value->img6; ?>">
                                            <img src="<?=base_url('')?>assets/uploads/img/<?= $events_value->img6; ?>"
                                                class="img-responsive" alt="" title="">
                                        </a>
                                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12 img_swiper img_swiper_57 p0">
                    <img src="<?=base_url('')?>assets/uploads/img/<?= $events_value->img6; ?>" class="" alt="" title="">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                        <video class="video-style col-lg-12 col-md-12 col-sm-12 col-xs-12 video p0" id="video_clip"
                            poster="<?=base_url('')?>assets/uploads/img/<?= $events_value->img1; ?>" preload="" playsinline controls>
                            <source
                                src="<?=base_url('')?>assets/uploads/img/<?= $events_value->events_clip; ?>"
                                type="video/mp4">
        ...
        var map = L.map("map").fitBounds([
            [<?= $events_value->map_latitude; ?>, <?= $events_value->map_longitude; ?>]
        ]);
        L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', {
            attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors',
            maxZoom: 18
        }).addTo(map);
        var marker = L.marker([<?= $events_value->map_latitude; ?>, <?= $events_value->map_longitude; ?>]).addTo(map);
        var currentMarker;
