...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 06, 2020 at 01:54 PM
...
(10, 1, 15, 218, '<p>\n	66</p>\n', 1, 1, '<p>\n	99999999999999</p>\n', '<p>\n	6666</p>\n', '<p>\n	33.896259</p>\n', '<p>\n	48.74916</p>\n', NULL, NULL, NULL, 'fd8b2b2a2991088ac42ad2903212188a.jpg', '<p></p>', '<p></p>', NULL, NULL, NULL, NULL, 3, NULL, NULL, '1606850192', 12, '1607753454'),
(11, 1, 5, 278, 'dsadsa', 1, 1, NULL, NULL, '33.89622', ' 48.749923', 1, NULL, NULL, '<p></p>', '<p></p>', '37a96865e638406540500bcbda606035.jpg', '<p></p>', 'c3369359ca3e38d6d07dc11f8c706af5.jpg', '<p></p>', '0', 12, NULL, NULL, NULL, 1, '1606945853'),
(12, 1, 16, 223, 'mmmmmmmmmmmmmmmmmmmmmm', 1, 1, 'fffffffffffffffffffff', 'mmmmmmmmmmmmmmm', '33.896325', ' 48.748784', 1, 'fffffffffffffffffffffffffffffffffff', 'mmmmmmmmmmmmmm', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '0', 12, NULL, NULL, NULL, 365, '1638427190'),
(13, 1, 18, 271, '<p>\n	امروز</p>\n', 2, 2, '<p>\n	امروز</p>\n', '<p>\n	6666</p>\n', '<p>\n	33.896147</p>\n', '<p>\n	48.750077</p>\n', 1, '<p>\n	امروز</p>\n', '<p>\n	امروز</p>\n', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '<p></p>', NULL, 12, NULL, NULL, '1606891293', 60, '1612075260'),
(14, 1, 15, 217, 'sssssssssss', 1, 1, 'sdsdsd', 'dsdsds', '33.89625', ' 48.748897', 1, 'dsdsdsd', 'dsdsdss', '<p></p>', '<p></p>', '58c5c6d157f53dccdb4e89ca9e341583.jpg', '<p></p>', '<p></p>', '<p></p>', '0', 12, NULL, NULL, NULL, 90, '1614667530'),
(15, 1, 1, NULL, '', 0, NULL, '', '', '', '', NULL, '', '', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '0', 12, NULL, NULL, NULL, 30, '1609483998'),
(16, 1, 18, 271, 'الان', 1, 1, 'lllll', '09192183340', '33.896152', ' 48.74997', 1, '999', 'corssis248@gmail.com', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '838c042d0dae79ea75c743695bdb23de.jpg', '0', 12, NULL, NULL, NULL, 60, '1612076859'),
(17, 1, 14, 213, 'dsdsadsa', 1, 1, 'ccc', 'corssis248@gmail.com', '33.896219', ' 48.752384', 1, 'cc', 'corssis248@gmail.com', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '0', 12, NULL, NULL, NULL, 60, '1612420392'),
(18, 1, 15, 216, '<p>\n	dsadsa</p>\n', 1, 1, '<p>\n	سسسسسسسس</p>\n', NULL, '<p>\n	33.896294</p>\n', '<p>\n	48.748816</p>\n', 1, '<p>\n	سسسسسسسس</p>\n', NULL, '<p></p>', '<p></p>', '<p></p>', '<p></p>', '<p></p>', '<p></p>', NULL, 3, 1, NULL, '1607236908', 365, '1638772803');
...
DROP TABLE IF EXISTS `zgr_agahi_pay`;
CREATE TABLE IF NOT EXISTS `zgr_agahi_pay` (
  `agahi_pay_id` int(11) NOT NULL AUTO_INCREMENT,
  `accounts_id` int(11) NOT NULL,
  `agahi_id` int(11) NOT NULL,
...
INSERT INTO `zgr_agahi_pay` (`agahi_pay_id`, `accounts_id`, `agahi_id`, `authority`, `mobile`, `amount`, `pay_date`, `state_id`, `Status`) VALUES
(1, 1, 1, '000000000000000000000000000000180795', '09192183440', 1000, 'سه شنبه, ۱۱ آذر ۱۳۹۹', 0, 'OK'),
(2, 1, 1, '000000000000000000000000000000180795', '09192183440', 1000, 'سه شنبه, ۱۱ آذر ۱۳۹۹', 0, 'OK'),
(3, 1, 0, '000000000000000000000000000000180813', '09192183440', 1000, 'سه شنبه, ۱۱ آذر ۱۳۹۹', 0, 'OK'),
(4, 1, 0, '000000000000000000000000000000181014', '09192183440', 1000, 'چهارشنبه, ۱۲ آذر ۱۳۹۹', 0, 'OK'),
(5, 1, 0, '000000000000000000000000000000181015', '09192183440', 1000, 'چهارشنبه, ۱۲ آذر ۱۳۹۹', 0, 'OK'),
(6, 1, 14, '000000000000000000000000000000181022', '09192183440', 1000, 'چهارشنبه, ۱۲ آذر ۱۳۹۹', 0, 'OK'),
(7, 1, 16, '000000000000000000000000000000181047', '09192183440', 1000, 'چهارشنبه, ۱۲ آذر ۱۳۹۹', 0, 'OK'),
(8, 1, 18, '000000000000000000000000000000185653', '09192183440', 1000, 'یکشنبه, ۱۶ آذر ۱۳۹۹', 0, 'OK');
...
DROP TABLE IF EXISTS `zgr_settings`;
CREATE TABLE IF NOT EXISTS `zgr_settings` (
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1607236050, 1, 'Admin', 'istrator', 'ADMIN', '0');
