...
qq.FineUploader=function(a){qq.FineUploaderBasic.apply(this,arguments);qq.extend(this._options,{element:null,listElement:null,dragAndDrop:{extraDropzones:[],hideDropzones:!0,disableDefaultDropzone:!1},text:{uploadButton:"آپلود فايل",cancelButton:"لغو",retryButton:"تلاش دوباره",failUpload:"آپلود ناموفق",dragZone:"جهت آپلود فايل خود را رها كنيد",dropProcessing:"در حال پردازش ",formatProgress:"{percent}% از {total_size}",waitingForResponse:"در حال پردازش"},template:'<div class="qq-uploader">'+
