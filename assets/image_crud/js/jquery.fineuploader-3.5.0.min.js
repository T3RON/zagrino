...
qq.FineUploader=function(a){qq.FineUploaderBasic.apply(this,arguments);qq.extend(this._options,{element:null,listElement:null,dragAndDrop:{extraDropzones:[],hideDropzones:!0,disableDefaultDropzone:!1},text:{uploadButton:"آپلود فايل",cancelButton:"لغو",retryButton:"تلاش دوباره",deleteButton:"حذف",failUpload:"آپلود ناموفق",dragZone:"Drop files here to upload",dropProcessing:"در حال پردازش",formatProgress:"{percent}% از {total_size}",waitingForResponse:"در حال پردازش"},template:'<div class="qq-uploader">'+
