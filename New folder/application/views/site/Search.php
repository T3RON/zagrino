<?php include_once (APPPATH.'views/_layout/site/header.php'); ?>
    ...
    <div class="ghavanin fnt_18">
               جستوجو برای کلمه <<بانک>>
               <div class="bottom"></div>
           </div>
        <!-- Bank_Mashaghel -->
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 banks_jobs section_head p0">
            
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_l outer borde_r_35 m_p_10 l p0">
                <div class="inner m_l_15 p0">بانک مشاغل</div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 left_side border_none p0">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 Takhfifat section_head p0">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_l outer l borde_r_35 m_p_10 p0">
                <div class="inner m_l_15 p0">تخفیفات</div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 left_side border_none p0">
                <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
        ...
        <div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section_head Agahiha_Niazmandiha p0">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_l outer l borde_r_35 m_p_10 p0">
                <div class="inner m_l_15 p0">آگهی ها و نیازمندی ها</div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 left_side border_none p0">
                <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 c_bg p0">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 upper p0">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 c_text f_l p0">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 c_title f_r p0"><a href="">فروش یک دستگاه وسیله نقلیه</a></div>
                                </div>
                            </div>
        ...
        <div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12 Roidad section_head p0">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_l outer l borde_r_35 m_p_10 p0">
                <div class="inner m_l_15 p0">رویدادها</div>
            </div>
        ...
        <div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12 Bazarche section_head p0">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 f_l outer l borde_r_35 m_p_10 p0">
                <div class="inner m_l_15 p0">بازارچه</div>
            </div>
