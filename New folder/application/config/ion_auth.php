 ...
 */
$config['site_title']                 = "باشگاه ورزشی ستارگان";       // Site Title, example.com
$config['admin_email']                = "seif4847@gmail.com"; // Admin Email, admin@example.com
...
$config['message_start_delimiter'] = '<p style="margin-bottom: 20px;background: antiquewhite;padding: 5px;border-radius: 10px;font-size: 12px;text-align: center;">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p style="margin-bottom: 20px;background: #e01900;color: #fff;padding: 5px;border-radius: 10px;font-size: 12px;text-align: center;">';		// Error message start delimiter
