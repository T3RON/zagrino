...
function Dropify(element, options) {
    ...
    var defaults = {
        ...
        messages: {
            'default': 'فايل مورد نظر خود را در اين بخش رها كنيد',
            'replace': 'فايل مورد نظر خود را در اين بخش رها كنيد',
            'remove':  'حذف',
            'error':   'آخ ، خطايي روخ داده است'
        },
        error: {
        ...
        tpl: {
            ...
            message:         '<div class="dropify-message"><span class="file-icon" /> <p style="text-align: center;font-family: \'IRANYekan\', \'Helvetica Neue\', Helvetica, Arial, sans-serif;">{{ default }}</p></div>',
    ...
    this.imgFileExtensions = ['png', 'jpg', 'jpeg', 'gif', 'bmp','mp4'];
